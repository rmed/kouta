...
namespace kouta::tests::db::query
{
    ...
    TEST(DbTest, SelectQuery)
    {
        ...
        ASSERT_EQ(builder.query(), "SELECT * FROM mytable5 WHERE (col1 = :col1) LIMIT 4");
        ...
        builder.select("mytable6", {"col1", "col2", "col3"})
            .order_by({{"col1", QueryBuilder::Order::Descending}, {"col2", QueryBuilder::Order::Ascending}});

        ASSERT_EQ(builder.query(), "SELECT col1, col2, col3 FROM mytable6 ORDER BY col1 DESC, col2 ASC");
